...
OUTPUT_FILE = Path("results/judge_evaluation/10personas_persona_aware_results.json")
LOG_FILE = Path("logs/judge_evaluation_10personas_persona_aware.log")
...
def main():
    ...
    log("="*80)
    log("JUDGE EVALUATION: 10 PERSONAS (PERSONA-AWARE)")
    log("="*80)
